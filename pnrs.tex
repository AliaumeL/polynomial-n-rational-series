...
\kl{$\Nat$-rational polynomials}, which will be a base case in an upcoming
induction.
...
\begin{proof}[Proof Idea]
    ...
    \end{equation*}
    Because $f$ is \kl{commutative}, we can restrict our attention
...
\kl{commutative} \kl{$\Rel$-polyregular functions}
