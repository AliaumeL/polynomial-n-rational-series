...
\NewDocumentCommand{\proofref}{m}{%
    \ifdefined\insideRestate%
        \marginpar{\vspace{0.6em}\ttfamily\small\hyperref[#1]{Go to \cref{#1} p.\pageref{#1:proof}}}%
    \else%
    ...
    \IfRefUndefinedExpandable{#1:proof}{}{%
        ...
        \marginpar{\vspace{0.6em}\ttfamily\small\hyperref[#1:proof]{Go to proof of \cref{#1} p.\pageref{#1:proof}}}%
    }%
    \fi%
}
