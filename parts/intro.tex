...
as \kl{$\Nat$-polyregular functions} ($\NPoly$) and \kl{star-free
$\Nat$-polyregular functions} ($\NSF$) \cite{DOUE21,DOUE22}. From this
...
($\ZPoly$) that generalize \kl{$\Nat$-polyregular functions} by allowing
...
this class of functions the aperiodic variant $\ZSF$ has been shown to
