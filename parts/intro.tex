...
\cite{CHOF03}, and more recently for rational functions \cite{FGL18}.
...
\kl{polyregular functions}, because of the extra expressive power introduced by
...
by \cite[Theorem 3.3, page 4; re-introduced as \cref{karh:thm}]{KARH77}.
