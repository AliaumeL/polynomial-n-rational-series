...
\kl{$\Rel$-rational series}, hence of \kl{$\Rel$-polyregular functions}. This
ensures that the present paper, focusing of \kl{commutative} functions,
considers functions in a decidable subclass. The proof is straightforward in
the case of \kl{$\Rel$-polyregular functions}, and slightly more involved for
general \kl{$\Rel$-rational series}.
