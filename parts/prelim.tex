...
\subsection{Polynomials} \AP A polynomial $P \in
...
\AP A \intro{monomial} is a product of indeterminates and integers.
...
A \kl{monomial} $S$ \intro{divides} a \kl{monomial} $T$, when $S$ divides
