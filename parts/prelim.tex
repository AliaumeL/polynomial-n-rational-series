...
\begin{lemma}[$\Rel$-polyregular functions {\cite{CDTL23}}]
...
\begin{example}
    ...
    $f \in \NSF[1]$.
    \proofref{non-canonical-transd:ex}
\end{example}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \begin{tikzpicture}[
            ...
            \draw[->] (B) to[bend right=45] node[midway, above] {$a \mid 1 - 2 \times \ind{\card{w} = 0}$} (A);
        \end{tikzpicture}
