...
\AP In full generality, \cref{size-of-word-nsf:ex,q-polynomial-n-poly:ex} can be generalized to demonstrate that functions
of the following functions can be \kl{represented} by a \kl{commutative}
\kl{star-free $\Nat$-polyregular function}: $x \mapsto \binom{x - p}{k}$ for $p
