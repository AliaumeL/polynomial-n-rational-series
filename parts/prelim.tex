...
$\Rel$, we will only provide the definiton of \kl{polyregular functions} for
these two output semgroups, and we refer the reader to
\cite{bojanczyk2019string} for the general definition of \kl{polyregular
functions}. The following \cref{nat-rel-poly:def} is one of the equivalent
