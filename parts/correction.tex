...
considering as ``basic polynomials" the \intro{binomial polynomials} of the
form $\binom{X - \ell}{k}$, where $\ell$ and $k$ are natural numbers. This is
why we introduce the notion of \intro{natural binomial polynomial} as
$\Nat$-linear combinations of products of \kl{binomial polynomials}.
