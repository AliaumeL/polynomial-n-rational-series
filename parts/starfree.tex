...
\begin{proof}
    ...
    the \kl{$\omega$-type} of the input which is possible using a
    \kl{polyregular function}, and then computing
    the suitable \kl{strongly natural binomial polynomials} which is possible
    ...
    it has \kl{growth rate} at most $d$
    ...
    $P_{(S, \vec{r})}$ are \kl{strongly natural binomial polynomials} for all
    ...
    and one can decide 
    whether a polynomial is \kl{strongly natural binomial polynomial} using
